...
Tested and running on a Raspberry Pi Pico W and Pico 2 W with MicroPython 1.25.0.
...
```python
wifi = PicoWifi()
wifi.credentials = WifiCredentials(ssid="SSID", password="password", filepath="wifi.json")
wifi.connectToWifi()
```
